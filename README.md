...
| **[Automatic License Plate Recognition in Cambodia (ALPRC)](https://github.com/lyheng01-s/automatic-license-plate-recognition-cambodia)** | A real-time AI system that detects and recognizes Cambodian vehicle license plates using YOLOv8 and OCR. It supports traffic monitoring, surveillance, and smart city development. | Python, YOLOv8, PaddleOCR, EasyOCR, Roboflow, Flask |
